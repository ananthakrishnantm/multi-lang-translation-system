...
class TranslationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.TranslateFrenchToEnglish = channel.unary_unary(
                '/TranslationService/TranslateFrenchToEnglish',
...
def add_TranslationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TranslateFrenchToEnglish': grpc.unary_unary_rpc_method_handler(
                    servicer.TranslateFrenchToEnglish,
    ...
    server.add_registered_method_handlers('TranslationService', rpc_method_handlers)
...
class TranslationService(object):
    ...
    @staticmethod
    def TranslateFrenchToEnglish(request,
            target,
            options=(),
